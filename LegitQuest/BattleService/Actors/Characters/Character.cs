...
namespace BattleService.Actors.Characters
{
    public abstract class Character : Actor
    {
        ...
        public override List<Message> processEvents()
        {
            List<Message> returnValues = new List<Message>();
            ...
            while(messages.Count > 0)
            {
                ...
                else if (message is Taunt)
                {
                    ...
                    if (specificMessage.target.id == this.id)
                    {
                        ...
                        returnValues.Add(specificMessage);
                    }
            ...
            if (isDefeated())
            {
                ...
                defeated.id = this.id;
                defeated.isAlly = (this is PlayerCharacter);
            }

            return returnValues;
        }

        public override List<Message> processDeltaTime(int time)
        {
        ...
        public override List<Message> processFinal()
        {
